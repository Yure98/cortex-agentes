---
name: raiox
description: Aciona raio-x-cnis no Cortex
---

Ler integralmente e executar a skill `raio-x-cnis` em `~/.claude/skills/raio-x-cnis/SKILL.md` (ou na instalação local equivalente), incluindo seu protocolo comum.
